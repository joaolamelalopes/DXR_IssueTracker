...
function getResolutionClass(resolution: string): string {
  ...
  if (resolution === 'Other (please comment)') return 'bg-red-100 text-red-800';
  return 'bg-gray-100 text-gray-800';
}
          ...
          <div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div>
              <div className="flex items-start gap-3">
                <span className="inline-block bg-green-100 text-green-800 text-sm font-semibold px-3 py-1 rounded-full">Accepted</span>
                <p className="text-sm text-gray-600 pt-1">"Valid finding, we own it" or "Valid finding, but wrong owning team"</p>
              </div>
            </div>
            
            {/* Row 1 Right: If Accepted → Resolution */}
            <div>
              <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">If Accepted → Resolution</h4>
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-yellow-100 text-yellow-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Deferred</span>
                  <p>Not in any release plan yet</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-green-100 text-green-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Planned</span>
                  <p>Part of a release plan</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-purple-100 text-purple-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Redirected</span>
                  <p>Ownership belongs to another team (DS, FE, UI5, etc.)</p>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-blue-100 text-blue-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Completed</span>
                  <p>Issue is fixed</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-start gap-3">
                <span className="inline-block bg-red-100 text-red-800 text-sm font-semibold px-3 py-1 rounded-full">Rejected</span>
                <p className="text-sm text-gray-600 pt-1">"We disagree. True pushback."</p>
              </div>
            </div>
            
            {/* Row 2 Right: If Rejected → Reason */}
            <div>
              <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">If Rejected → Reason</h4>
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5 whitespace-nowrap">Repeated in same DXR report</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5 whitespace-nowrap">Customer/partner generated</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Against guidelines</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Intentional deviation</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="inline-block bg-red-100 text-red-800 text-xs font-medium px-2 py-0.5 rounded-full mt-0.5">Other (please comment)</span>
                </div>
              </div>
            </div>
          </div>
