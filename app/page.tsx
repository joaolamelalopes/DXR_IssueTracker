      ...
      {isOpen && (
        <div className="mt-4 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200">
            <h3 className="font-semibold text-gray-900 mb-3">If Rejected → Valid reasons</h3>
            <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
              <li>Issue is repeated in the same DXR report</li>
              <li>Issue was generated by customer/partner</li>
              <li>Recommendation goes directly against guidelines (UA, Accessibility, other)</li>
              <li>Deviation to the guideline is intentional</li>
              <li>Other (please specify reason in Comments)</li>
            </ul>
          </div>
        </div>
      )}
